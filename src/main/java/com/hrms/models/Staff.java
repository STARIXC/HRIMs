...
public class Staff {
	...
	public Staff(int id, String emp_no, String first_name, String surname, String other_name, String gender,
			String phone, String email, String dob, String home_address, String postal_code, String nationality,
			String disability, String disability_explain, String national_id, String mfl, String position,
			String date_started, String date_ended, String months_worked, String current_contract,
			String contract_period, String contract_end_date, String expected_months, String status, String kra_pin,
			String nssf_no, String nhif_no, String cert_good_conduct_no, String helb_clearance_no, int helb_benefitiary,
			int active, String bank_name, String branch, String account_name, String acount_number) {
		super();
		this.id = id;
		this.emp_no = emp_no;
		this.first_name = first_name;
	...
	public String toString() {
		return "Staff [id=" + id + ", emp_no=" + emp_no + ", first_name=" + first_name + ", surname=" + surname
				+ ", other_name=" + other_name + ", gender=" + gender + ", phone=" + phone + ", email=" + email
				+ ", dob=" + dob + ", home_address=" + home_address + ", postal_code=" + postal_code + ", nationality="
				+ nationality + ", disability=" + disability + ", disability_explain=" + disability_explain
				+ ", national_id=" + national_id + ", mfl=" + mfl + ", position=" + position + ", date_started="
				+ date_started + ", date_ended=" + date_ended + ", months_worked=" + months_worked
				+ ", current_contract=" + current_contract + ", contract_period=" + contract_period
				+ ", contract_end_date=" + contract_end_date + ", expected_months=" + expected_months + ", status="
				+ status + ", kra_pin=" + kra_pin + ", nssf_no=" + nssf_no + ", nhif_no=" + nhif_no
				+ ", cert_good_conduct_no=" + cert_good_conduct_no + ", helb_clearance_no=" + helb_clearance_no
				+ ", helb_benefitiary=" + helb_benefitiary + ", active=" + active + ", bank_name=" + bank_name
				+ ", branch=" + branch + ", account_name=" + account_name + ", acount_number=" + acount_number + "]";
	}
